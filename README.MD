...
> _Choose where the wallpaper goes._

Both actions include a **Monitor** setting with three modes:
...
- Playlist mode, cycle through a curated set of wallpapers on a timer or key press.
